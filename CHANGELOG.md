...
- Changed: `consecutive-duplicates` to `consecutive-duplicates-with-different-values` for `consecutive-duplicates-with-different-values` rule.
...
- Chore **(Major update)**: minimum required `stylelint-order` version is now `^0.6.0`.
...
- Chore **(Major update)**: minimum required `stylelint-order` version is now `^0.5.0`.
- Chore **(Major update)**: minimum required `stylelint` version is now `^7.11.0`.
...
- Changed: properties orderin `order/declaration-block-properties-specified-order`.
...
- Chore **(Major upgrade)**: minimum required `stylelint` version is now `^7.3.1`. Version `7.4.0`, `7.4.1` is buggy.
...
- Chore **(Major update)**: minimum required `stylelint` version is now `^7.2.0`. Version `7.3.0` is buggy.
